// // App.js — Root component, theme provider, layout shell
...
//       return sample;          // returns the data to InputPanel
//     } catch {
...
//                   onToggleExplanation={() => setShowExplanation(s => !s)}
//                 />
...
//                 <AdjacencyTable adjacencyList={graphData.adjacency_list} />
//               </>
//             )}
//           </section>
//         </div>
...
// App.js — Extended with Banker's algorithm support
import React, { useState, useCallback } from 'react';
import Header from './components/Header';
import InputPanel from './components/InputPanel';
import GraphCanvas from './components/GraphCanvas';
